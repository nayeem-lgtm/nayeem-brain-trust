...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nayeem Co-Pilot — AI Chief of Staff" },
      { name: "description", content: "Your AI executive assistant. Brain-dump tasks in plain English; Nayeem Co-Pilot organizes, prioritizes, schedules and tracks them." },
      { property: "og:title", content: "Nayeem Co-Pilot — AI Chief of Staff" },
